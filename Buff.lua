...
function Buff:onTrigger(entity)
	if bit_and(self.buffDta.n32Flags,Buff.Flags.Damage) > 0 then
		if self.Stats.n32RecvHp ~= 0 then
			entity:addHp(self.Stats.n32RecvHp, HpMpMask.BuffHp)
		end
		if self.Stats.n32RecvMp ~= 0 then
			entity:addMp(self.Stats.n32RecvMp, HpMpMask.BuffMp)
		end
	end
end
